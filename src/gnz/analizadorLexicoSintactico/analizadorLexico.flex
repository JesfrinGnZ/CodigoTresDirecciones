...
%% //------------------>3er area<--------------------------    
 ...
 //  ["+"|"-"]?{Digitos}["."]{Digitos} {return symbol(DECLARACION_DOUBLE,yytext());}
 //  ["+"|"-"]?{Digitos}["."]{Digitos}["f"] {return symbol(DECLARACION_FLOAT,yytext());}
 //  ["+"|"-"]?{Digitos} {return symbol(DECLARACION_ENTERO_LONG,yytext());}
